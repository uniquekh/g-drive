...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '7332862690:AAERn6R98wOfzTx8OkXFXM5p9UUorJnx6CY' # Get it from https://t.me/BotFather
    APP_ID = '21179966' # Get it from my.telegram.org/apps
    API_HASH = 'd97919fb0a3c725e8bb2a25bbb37d57c' # Get it from my.telegram.org/apps
